---
title: "Associate Editor's Guide"
...
AE_df <- create_node_df(n=10, 
   ...
   label=c("Send for review?", #1
           ...
           "Update reviewer in DESCRIPTION, rj::add_reviewer()", #3
           "Invite reviewers \n (1) generate email template into correspondence folder using rj::invite_reviewers(), \n(2) send email which includes pdf and R files", #4
           "Check all file changes into GitHub", #5
