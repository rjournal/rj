...
Once accepted, the authors should submit the final version within two weeks. Once submitted, add this to the Accepted article and mark it as proofed using `rj::update_status("<article_id>", "proofed")`.
