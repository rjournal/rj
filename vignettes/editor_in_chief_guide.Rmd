...
Articles are submitted through a [Google form](https://forms.gle/ykj6QcoGQD5ctnA5A) which populates a [Google sheet](https://docs.google.com/spreadsheets/d/15Tem82ikjHhNVccZGrHFVdzVjoxAmwaiNwaBE95wu6k/edit#gid=1671813370). This sheet contains details of the submission, and also a zip file with the necessary files. 
...
TO BE UPDATED WITH NEW WEB SITE DESIGN
