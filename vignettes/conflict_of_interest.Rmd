---
title: "Draft: Conflict of Interest"
author: "Mark van der Loo"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Conflict of Interest}
...
For the R Journal, it is important that all decisions taken on papers are
...
described in a plain text file called `conflicts.txt` and stored in the
`correspondence` folder with the submission. The description should at least contain:
